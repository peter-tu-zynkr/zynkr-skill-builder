...
export const categories: Category[] = [
  ...
  },
  {
    ...
    name: "開發運營",
    icon: "🛠️",
    description: "AI 助理設計、流程優化與市場部署的開發工具",
  },
  {
    prefix: 6,
    slug: "tech",
    name: "技術",
    icon: "💻",
    description: "平台工程、自動化整合與資料智慧的技術工具",
  },
  {
    prefix: 7,
...
export const projects: Project[] = [
  ...
  // 技術 (placeholder — no projects yet)
  // 人才發展
  {
    slug: "resume",
    name: "履歷客製化",
  ...
  // 財務行政 (placeholder — no projects yet)
];
