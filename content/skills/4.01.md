...
process: >-
  Transcribe the video, remove filler words, and map the content to the
  reference outline (strictly ignoring reference text detail).
output: >-
  A reader-friendly document structured into Summary, Theme, Q&A, Tools, and
