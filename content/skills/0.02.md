...
description: >-
  ...
  /planning-tracker-sync (the TEAM weekly tracker block, nudges and snapshots —
  it consumes this skill's derived-state rules, but the founder brief stays
  here), the rest of the planning suite 0.03-0.10 (a planning CYCLE: pre-work,
  offsite synthesis, tracker build, OKR reconcile),
