...
description: >-
  ...
  with Y', 'what's in my queue', 'I have an idea about', '幫我看一下這個',
  '/zynkr-skills', or when the user pastes a link with no further direction.
  Triggers MORE eagerly than the specific skills below it — when in doubt, route
  through /zynkr-skills rather than asking the user to remember the right slash
  command. Also fire on deck / 簡報 requests — 'make me a deck', '幫我做簡報', '做投影片',
  'pitch deck', 'deep dive 簡報', 'all-hands 簡報', '把這份資料做成簡報' — and route them to
  /zynkr-slide (the slide-relay orchestrator).
input: >-
...
synergy:
  - '6.02'
installCommand: curl -sL zynkr.ai/s/6.02.md -o ~/.claude/skills/zynkr-skills.md
updatedAt: '2026-06-27'
firstSeen: '2026-06-09'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 6-engineer/zynkr-skills/SKILL.md
---
