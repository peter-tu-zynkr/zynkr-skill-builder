...
process: >-
  Decode hiring intent, role context, priorities, success metrics, and ATS
  filters using structured analysis (MECE, 80/20).
output: >-
  Clear role summary, prioritized skills, success KPIs, and ATS-ready keywords
  for CV tailoring and interview prep.
ipoProvenance:
  input: csv
  process: csv
  output: csv
