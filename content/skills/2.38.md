...
description: >-
  ...
  recording — into a clean zh-TW transcript filed straight into the client's
  numbered [N] Drive project folder and linked on the CRM deal. A thin
...
input: >-
  A Fireflies meeting (id/URL/name — already transcribed, no upload) or a
  recording of an engagement session, + the engagement (deal URL / company) and
  the phase.
process: >-
