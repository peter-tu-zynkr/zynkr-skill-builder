...
author: Peter Tu
description: >-
  Publishes a finalized post to your SOCIAL channels — Facebook, Threads &
  Instagram — via the Buffer API, with per-channel formatting, Instagram image
  support, and a preview-confirm gate before anything posts. Use when you say
  'publish my post', 'post this to Threads/IG/FB', 'push this draft live to
  social', or 'schedule this post'. The SOCIAL publisher — not the website/blog
  one (seo-publish-article).
input: >-
...
synergy:
  - '1.29'
installCommand: curl -sL zynkr.ai/s/1.29.md -o ~/.claude/skills/social-publish-article.md
updatedAt: '2026-07-02'
firstSeen: '2026-06-14'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 1-brand-marketing/social-publish-article/SKILL.md
---
