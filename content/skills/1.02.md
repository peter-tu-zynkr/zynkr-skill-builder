...
input: >-
  User gives article draft (topic + core ideas); templates and style guide are
  preloaded.
process: >-
  Multi-turn - propose 3 outlines, 3 key points per section, then write
  paragraphs stepwise with user review, following the style guide.
output: >-
  Clear outline, section bullet lists, and a 1000–1200-word article drafted in
  the user’s style.
ipoProvenance:
  input: csv
  process: csv
...
sourceFile: .claude/agents/article-style-selector.md
---
