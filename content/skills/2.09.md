...
description: >-
  ...
  and says "draft a reply", "draft an outbound mail", "回這個", "幫我擬回覆", "把這個 lead
  建進 CRM 並擬信", "log this lead and draft the email", "turn this DM into a draft",
  or otherwise hands over a back-and-forth where someone agreed to a demo / call
  / next step and wants both the CRM record and the reply prepared. Distinct
  from consult-intake (a weekly BATCH sweep of inbound website consult EMAILS)
  and consult-project-specialist (documents ONE sales/consulting MEETING
  transcript into a project + Drive folder + deal): this one takes ONE short
  outreach/DM conversation and produces a lead record + a drafted reply, no
...
synergy:
  - '2.09'
installCommand: curl -sL zynkr.ai/s/2.09.md -o ~/.claude/skills/outreach-responder.md
updatedAt: '2026-06-27'
firstSeen: '2026-06-27'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 2-sales-consultant/outreach-responder/SKILL.md
---
