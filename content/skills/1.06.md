...
process: >-
  Analyze the article’s theme, audience, and conversion goal, then match it to
  approved CTA categories and templates defined in Zynkr’s CTA handbook .
output: >-
  Three ready-to-use CTA options with titles, copy, category, sub-goal,
  placement advice, and validated links.
ipoProvenance:
  input: csv
  process: csv
  output: csv
...
sourceFile: .claude/agents/cta-writer.md
---
