...
input: >-
  User provides an article, topic, or file; limited Memory (SEO + style
  preferences) may be referenced.
process: >-
  Generate either 10 SEO titles or a full SEO strategy. Use Taiwan search
  habits, five MECE topic categories, keyword groups, outlines, and optimization
  advice. Never invent memory or rewrite user content.
output: >-
  SEO titles with reasons and MECE classification, or a complete SEO strategy
  with keywords, outline, and recommendations.
ipoProvenance:
  input: csv
  process: csv
  output: csv
...
sourceFile: .claude/agents/article-title-suggester.md
---
