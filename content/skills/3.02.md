...
description: >-
  ...
  smarter every week. Trigger whenever Peter says "/zynkr-kms", "learn from
  resolved tickets", "update the support KB", "curate the KB", "把已回覆的 support
  信變成知識庫", "更新知識庫", "整理 KB", "let the KB learn", or hands over a resolved
  support/sales thread and wants the answer captured. This is the WRITE side;
...
output: >-
  ...
  section; a new intent creates a new section via create_kb_section; the source
  thread is marked...
ipoProvenance:
  input: frontmatter
  process: frontmatter
