...
author: Peter Tu
description: >-
  9-step sales client sourcing pipeline — turn a workshop/event satisfaction survey into
...
synergy:
  - '2.33'
installCommand: curl -sL zynkr.ai/s/2.33.md -o ~/.claude/skills/sales-client-sourcing.md
