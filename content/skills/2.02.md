...
process: >-
  Identify skill gaps, guide structured SCQA storytelling, probe for clarity,
  and refine impact-focused narratives
output: >-
  Clear, job-aligned skill stories ready for CV bullets, interviews, or fit
  assessment
ipoProvenance:
  input: csv
  process: csv
...
kind: skill
synergy: []
installCommand: curl -sL zynkr.ai/s/2.02.md -o ~/.claude/skills/followup-email-writer.md
