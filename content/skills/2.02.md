...
description: >-
  ...
  drafting. Takes business-card IMAGES specifically — the OCR pass is the point.
  When the lead signal already arrives as text (a DM thread, an event feedback
  row, a website enquiry), use sales-outbound instead; for a WHOLE event survey
  sheet, use sales-client-sourcing.
