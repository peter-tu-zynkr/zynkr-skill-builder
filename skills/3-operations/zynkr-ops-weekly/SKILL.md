...
steps:
  - "start | start | 開始 · 每週一"
  - "nudge_be | llm | 貼出週報提醒 · 一 09:05"
  - "nudge_fe | output | 大廳貼出提醒"
  - "team | input | 六人各自貼 #週報"
  - "rollup | llm | 彙整並分流到各部門 · 二 09:05"
  - "chips | knowledge | 路由規則 · 讀 Doc 的人名晶片 | ref=atlas:zynkr-ops-weekly.routing"
  - "doc | store | 營運每週彙報 Doc · 當週區塊 | ref=atlas:ops-weekly-doc"
  - "gate_miss | gate | 有人沒交嗎"
  - "chase_be | llm | 點名補件 · 二 09:35"
  - "chase_fe | output | 大廳點名補件"
  - "agenda | llm | 產出週四議程 · 三 17:05"
  - "tracker | knowledge | H2 主追蹤表 · 逾期項目 | ref=atlas:ops-weekly-main-tracker"
  - "okr | knowledge | OKR & KPI 追蹤表 · 未達標的數字 | ref=atlas:ops-weekly-okr-tracker"
  - "wording | knowledge | 用字規則 · 講人話 | ref=atlas:zynkr-ops-weekly.wording"
  - "agenda_fe | output | 大廳貼出議程連結"
  - "meeting | hitl | 週四會議 · 只談例外 · 21:00"
  - "decide | llm | 抽出決議並回貼 · 四 22:05"
  - "mail | output | 完整版 recap 寄給六位 owner"
  - "gate_sent | gate | 信真的寄出去了嗎"
  - "register | store | 決議登記表 · 尚未設定"
  - "fail | offpage | 失敗通知 · 另一張圖"
  - "scaffold | deterministic | 複製下週區塊 · 四 23:00 Apps Script"
  - "end | end | 結束 · 下週一再來"
flow:
  - "start -> nudge_be"
  - "nudge_be -> nudge_fe"
  ...
  - "team -> rollup"
  - "rollup -> gate_miss"
  - "gate_miss -> chase_be | 有人沒交"
  - "gate_miss -> agenda | 都交了"
  - "chase_be -> chase_fe"
  - "chase_fe -> agenda"
  - "agenda -> agenda_fe"
  - "agenda_fe -> meeting"
  ...
  - "decide -> mail"
  - "mail -> gate_sent"
  - "gate_sent -> scaffold | 寄出成功"
  - "gate_sent -> decide | 沒寄出 · 最多重試 3 次"
  - "gate_sent -> fail | 3 次都失敗 · 放棄"
  - "scaffold -> end"
  - "chips ~> rollup | 路由"
  - "rollup ~> doc | 寫入彙整區塊"
  - "okr ~> rollup | 補數字"
