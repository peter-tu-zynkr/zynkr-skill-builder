...
| 3.0 | `3.0 operation/` | `1Y2St1Zaj3j3VS_iiPU_-TcltgR8LuBde`, `11QZXKwXsKZlNo42d0jfXaW1eiV5mHogD`, `1LpymoVhy4YrxDBi81Sw6CRQQbZAiSLQ6`, `1nnoKI115tWCMPOXTuWCbCW445v3BJZy6` | `[3.0] 營運部門：諮詢案例，行政，流程`, `[3.1] 營運部門：線上或線下活動`, `[3.2] 客服知識庫 (KMS)`, `[3.3] 專案管理 PMO｜Playbook & Templates` | Cloud canonical (most active). **Scan all four.** `[3.1]`–`[3.3]` are Drive-ROOT siblings of `[3.0]`, not children — parentage verified 2026-09-02 — so a scan of `[3.0]` alone silently misses them. `[3.3]` is the PMO Playbook + template home the `project-*` skills copy from (`SKB-011`); `[3.2]` is mirrored by `zynkr-kms`. Same shape as LOB 7 below |
