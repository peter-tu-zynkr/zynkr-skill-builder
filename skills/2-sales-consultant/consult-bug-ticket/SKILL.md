...
Use `mcp__zynkr__create_task(deal_id="<deal_id>", …, confirm=true)` — it is
created as you, on your workspace, so there is no owner id to resolve and none
to hardcode. Then append to the deal's notes:
