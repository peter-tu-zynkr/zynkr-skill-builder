...
shows up on the live contacts page (`https://platform.zynkr.ai/contacts`),
...
- One row back (a `contact_id`) → created. Display:
  ```
  ✓ [Contact Name] @ [Company] — added to CRM → https://platform.zynkr.ai/contacts/[contact_id]
  ```
...
CRM contacts: https://platform.zynkr.ai/contacts
=============================================
```
