...
- **No hype, no 句號, no emoji numerals.** Cell copy obeys house style: zh-TW headings/labels take no 句號 (。), series separators use ·, and numbered items use plain digits — emoji numerals (1️⃣2️⃣3️⃣) are banned house-wide (SDD §4.4). Tone stays no-hype; banned words are owned by 《[3.2] 禁用詞清單 Forbidden Words》 (`1N5sHLP4qzmmhpCGsi6KElxi1z0MFe4QZ0Q_35T10Uyg`) and must not appear in any cell. External-facing capability phrasing uses "powered by Claude".
